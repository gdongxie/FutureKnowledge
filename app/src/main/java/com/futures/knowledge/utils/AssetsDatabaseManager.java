package com.futures.knowledge.utils;
...
public class AssetsDatabaseManager {
    ...
    public SQLiteDatabase getDatabase(String dbfile) {
        ...
        SharedPreferences dbs =
                context.getSharedPreferences(AssetsDatabaseManager.class.toString(), 0);
        boolean flag = dbs.getBoolean(dbfile, false); // Get Database file flag, if true means
        // this database file was copied and valid
        if (!flag || !file.exists()) {
            file = new File(spath);
